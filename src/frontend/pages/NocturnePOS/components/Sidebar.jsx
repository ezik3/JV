...
const Icon = ({ children, className = '' }) => (
  <span className={`icon ${className}`} style={{ display: 'inline-block', width: '20px', height: '20px' }}>
    {children}
  </span>
);
...
const navItems = [
  ...
  { title: "Kitchen", id: "kitchen", icon: "🍳" },
  { title: "Menu", id: "menu", icon: "📖" },
  { title: "Tables", id: "tables", icon: "🪑" },
  { title: "Inventory", id: "inventory", icon: "📦" },
  { title: "Sales", id: "sales", icon: "💰" },
  { title: "Analytics", id: "analytics", icon: "📈" },
  { title: "Staff", id: "staff", icon: "👥" },
  { title: "Settings", id: "settings", icon: "⚙️" },
];
